<?php
    ...
    $sql = "insert into booknow(occasion, howmany, eventdate) values('$occasion', '$howmany', '$eventdate')";
    mysqli_query($con, $sql)  or die("Query Failed");
    $mailto = "shresthaasaugat31@gmail.com";
    $name = "kimara gurung";
...
<header>
    ...
    <a href="personal.php"><img src="logo1.png" class="logo" width="50px" height="50px " alt=""></a>
