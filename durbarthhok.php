...
<head>
    ...
    <script src="durbarthok.js"></script>
...
<header>
    ...
    <a href="business.php"><img src="logo1.png" class="logo" width="50px" height="50px " alt=""></a>
    ...
    <div class="container">
        <div class="content">
           <div class="left-content">
               ...
               <div class="f-logo">
               <h1> <i class="fas fa-utensils"></i>  Durbarthok Banquet</h1>

               <form action="addparty.php" method="post" enctype="multipart/form-data">

               
        <div class="input-field">
            <input type="text" name="partypalacename" placeholder="Enter your venue name"  required>
        ...
        <div class="input-field">
            <input type="text" placeholder="Enter details about venue" name="details" required>
        ...
        <div class="input-field">
            <input type="text" placeholder="enter if it is available" name="available" required>
            <i class="uil uil-lock icon"></i>
        </div>
        <div class="input-field">
            <input type="text" placeholder="Enter pricing" name="pricing" required>
            <i class="uil uil-lock icon"></i>
        </div>
        <div class="input-field">
            <input type="text" placeholder="Enter parking space" name="parkingspace" required>
            <i class="uil uil-lock icon"></i>
        </div>
    ...
    <input type="submit" name="submit" ></input>
                ...
                <img src="durbarthok1.jpg" id="pic"   alt="">

                <h1>Details</h1>
             
                <h2 class="th">Venue Suitable For Many Events, Ceremony,Seminar, General Meetings , Product Lunching Fashion Show And Parties </h2>
                <br>
                <br>
                <table>
                    <tr>
                    ...
                    <tr>
                        <th class="th"><i class="fas fa-location-arrow"> Newroad,Pokhara</i></th>
                        <th class="th">300-500 </th>
                        <th class="th"><i class="fas fa-check"></i>  </i></th>
                    </tr>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <th class="th"> <i class="fa fa-rupee"></i>150 </th>
                       
                    </tr>
                    <tr>
                        <th class="th">Standard Non-Veg Menu: </th>
                        <th class="th"> <i class="fa fa-rupee"></i>400 </th>
                    </tr>
                    <tr>
                        <th class="th">For Venue Space</th>
                        <th class="th"><div class="price">Rs 35,000.00 <span>Rs 50,000.00 </span> </div></th>
                    </tr>
