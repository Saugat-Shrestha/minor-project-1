...
<header>
    ...
    <a href="last.html"><img src="logo1.png" class="logo" width="50px" height="50px " alt=""></a>
        ...
        <div class="content">
           <div class="left-content">
               ...
               <h1> <i class="fas fa-utensils"></i>  <?php print($result['partypalacename']) ?></h1>
                ...
                <h2 class="th"> Hello people, have you been searching for a event management place OR confused with your parties? </h2>
                <br>
                <br>
                <table>
                    <tr>
                    ...
                    <tr>
                        <th class="th"><i class="fas fa-location-arrow"> Gairapatan-4,Pokhara</i></th>
                        <th class="th">200-500 </th>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <th class="th"> <i class="fa fa-rupee"></i>250 </th>
                       
                    </tr>
                    <tr>
                        <th class="th">Standard Non-Veg Menu: </th>
                        <th class="th"> <i class="fa fa-rupee"></i>500 </th>
                    </tr>
                    <tr>
                        <th class="th">For Venue Space</th>
                        <th class="th"><div class="price">Rs 25,000.00 <span>Rs 50,000.00 </span> </div></th>
                    </tr>
